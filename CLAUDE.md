# CLAUDE.md - French Standards MCP

MCP server for French government cybersecurity standards.
...
6 French cybersecurity standards: ANSSI RGS, ANSSI Guide d'hygiene, SecNumCloud, PGSSI-S, CNIL Guide securite, HDS.
